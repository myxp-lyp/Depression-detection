...
parser.add_argument("--output_dir", type=str, default="yp_phq_prediction_checkpoints")
...
def train():
    ...
    model = PeftModel.from_pretrained(base_model, os.path.join(args.output_dir, "checkpoint_epoch_5"))#"best_model"))
    model.eval()
    with torch.no_grad():
        all_preds = []
        all_participant_ids = []
