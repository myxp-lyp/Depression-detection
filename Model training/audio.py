...
class AudioDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return audio_features.squeeze(0), torch.tensor(score, dtype=torch.float32)
...
def prepare_models_use_non_DDPllama():
    ...
    llama_model = PeftModel.from_pretrained(basemodel, '/data/yl7622/emotion_detection/yp_phq_prediction_checkpoints/best_model')
    lora_config = LoraConfig(
        r=8, lora_alpha=16, lora_dropout=0.1, target_modules=["q_proj", "v_proj"]
    )
